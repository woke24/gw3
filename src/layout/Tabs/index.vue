  ...
  <div class="tabs">
    ...
    <div class="handle">
      ...
      <el-dropdown placement="bottom">
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item class="tab-ddropdown-item" :icon="RefreshLeft" @click="pageReload">
            ...
            >
              {{ $t('message.system.tab.closeCurrent') }}
            </el-dropdown-item>
            <el-dropdown-item
              class="tab-ddropdown-item"
              :icon="CircleClose"
            ...
            >
              {{ $t('message.system.tab.closeOther') }}
            </el-dropdown-item>
            <el-dropdown-item
              class="tab-ddropdown-item"
              :icon="CircleClose"
      ...
      <el-tooltip
        ...
        effect="dark"
        :content="
          contentFullScreen ? $t('message.system.fullScreenBack') : $t('message.system.fullScreen')
        "
        placement="bottom"
      >
